...
const FOOTER_LINKS = {
  Products: ['AI Voice Ordering', 'Next-Gen POS', 'Greeter Robots', 'Serving Robots', 'Wallet Loyalty'],
  Solutions: ['Quick Service', 'Fast Casual', 'Full Service', 'Enterprise'],
    ...
    <footer className="footer">
      ...
      <div className="container footer__bottom">
        <p className="footer__copy">
          &copy; {new Date().getFullYear()} Sentico, Inc. All rights reserved.
        </p>
